...
export default function Navbar() {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <a className="navbar-brand GiftLink" href="/">GiftLink</a>
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" to="/app/search">Search Page</Link>
                    </li>
                    ...
                    {isLoggedIn ? (
                        ...
                        <li className="nav-item"><button className="nav-link" style={{cursor:"pointer"}} onClick={handleLogout}>Logout</button></li>
                        </>
                    ):(
                    <>
                        <li className="nav-item">
